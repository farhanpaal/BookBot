...
from CloneFarhan.database.clone_bot_userdb import clonedb
from info import *
...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        if cd["update_channel_link"] != None:
            ...
            buttons.append([InlineKeyboardButton('🍿 Aᴜᴅɪᴏʙᴏᴏᴋs Cʜᴀɴɴᴇʟʟ 🍿', url=up)])
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            if cd["update_channel_link"] != None:
                up = cd["update_channel_link"]
                button = [[
                    InlineKeyboardButton('🍿 Aᴜᴅɪᴏʙᴏᴏᴋs Cʜᴀɴɴᴇʟʟ 🍿', url=up)
                ]]
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Audiobook or Book Files/Videos will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this ALL Files/Videos to your Saved Messages and Start Download there</i></b>")
...
async def settings(client, message):
    ...
    try:
        ...
        link = 'https://t.me/variablesupport'
