...
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Yᴏᴜ Wɪᴛʜ Tʜᴇ Bᴏᴏᴋs,Aᴜᴅɪᴏᴏᴋs,Aɴᴅ Usᴇғᴜʟ Rᴇsᴏᴜʀᴄᴇs Yᴏᴜ Nᴇᴇᴅ Tᴏ Gʀᴏᴡ Iɴ Yᴏᴜʀ Lɪғᴇ, ᴊᴜsᴛ ᴛʏᴘᴇ ᴡʜᴀᴛ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ 💘</b>"""
...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=ZHD-{}
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/Self_Improvement_AudioBook_Bot)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
• /deletefiles - <code>Tᴏ ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD Fɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    AUTO_DELETE_MSG = """<b>⚠️𝗤𝘂𝗶𝗰𝗸 𝗡𝗼𝘁𝗲:</b> \n\n ᴛʜɪs ᴍᴇssᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b>{}</b> ᴍɪɴᴜᴛᴇs<i> ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs</i> \n\n<b><i> Sᴀᴠᴇ ɪᴛ ɴᴏᴡ ɪɴ ʏᴏᴜʀ ᴅᴇᴠɪᴄᴇ ᴏʀ ғᴏʀᴡᴀʀᴅ ᴛᴏ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇs/ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ. </i></b>"""

    FILE_DELETED_MSG = """<b>✅Sᴜᴄᴄᴇssғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ \n
Yᴏᴜ Aʀᴇ Aʟᴡᴀʏs Wᴇʟᴄᴏᴍᴇᴅ Tᴏ Rᴇǫᴜᴇsᴛ Fɪʟᴇ Aɢᴀɪɴ</b>"""
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த Our Filter Bot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ Our Filter Bot బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس Our Filter Bot بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ Our Filter Bot બોટનું સંચાલન કરો
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই Our Filter Bot বট পরিচালনা করুন
...
/stream - ɢᴇᴛ sᴛʀᴇᴀᴍᴀʙʟᴇ ᴀɴᴅ ᴅᴏᴡɴʟᴏᴀᴅᴀʙʟᴇ ʟɪɴᴋ ᴏғ ᴀɴʏ ғɪʟᴇ</b>"""
    ...
    INPUT_REQUIRED = "❗ **Aʀɢᴜᴍᴇɴᴛs Tᴏ Kɪᴄᴋ Rqᴜɪʀᴇᴅ**"
